...
<div class="main-div">
    <form name="main_form" method="POST" action="/Test4/czxy/index.php/Admin/Gradeperiod/edit/id/1.html" enctype="multipart/form-data" >
    	<input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">学期信息：</td>
                <td>
                    <input  type="text" name="periodname" value="<?php echo $data['periodname']; ?>" />
                </td>
            </tr>
            <tr>
