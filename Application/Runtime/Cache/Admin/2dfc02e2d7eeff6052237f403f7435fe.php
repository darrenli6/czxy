...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/czxy/index.php/Admin/News/add.html" method="post">
            <table width="90%" id="general-table" align="center">
                <tr>
                 ...
                 <tr>
                    ...
                    <td><input type="text" name="author" value=""size="30" />
                    <span class="require-field">*</span></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="is_on_line" value="是"/> 是
                        <input type="radio" name="is_on_line" value="否"/> 否
                    </td>
                </tr>
