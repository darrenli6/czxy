...
<div class="form-div search_form_div">
    <form action="/Test4/czxy/index.php/Admin/Courseinfo/lst" method="GET" name="search_form">
		<p>
			课程名：
	   		<input type="text" name="coursename" size="30" value="<?php echo I('get.coursename'); ?>" />
		</p>
	...
	<table cellpadding="3" cellspacing="1">
		...
		<?php foreach ($data as $k => $v): ?>            
			<tr class="tron">
		        ...
		        <td align="center">
		        	<a href="<?php echo U('edit?courseid='.$v['courseid'].'&p='.I('get.p')); ?>" title="编辑">编辑</a> |
	                <a href="<?php echo U('delete?courseid='.$v['courseid'].'&p='.I('get.p')); ?>" onclick="return confirm('确定要删除吗？');" title="移除">移除</a> 
		        </td>
	        </tr>
        <?php endforeach; ?> 
