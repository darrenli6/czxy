...
<div class="main-div">
    <form name="main_form" method="POST" action="/Test4/czxy/index.php/Admin/Userrole/edit/id/3.html" enctype="multipart/form-data" >
    	<input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">用户角色名字：</td>
                <td>
                    <input  type="text" name="rolename" value="<?php echo $data['rolename']; ?>" />
                </td>
            </tr>
            <tr>
