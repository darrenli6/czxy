...
<div class="main-div">
    <form name="main_form" method="POST" action="/Test4/czxy/index.php/Admin/Wifisigninfo/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">MAC绑定手机号：</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input  type="text" name="phonemac" value="" />
                </td>
            </tr>
            <tr>
