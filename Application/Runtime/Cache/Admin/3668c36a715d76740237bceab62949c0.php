...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/Test4/czxy/index.php/Admin/Vote/edit/id/10.html" method="post">
            ...
            <table width="90%" id="general-table" align="center">
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                    <textarea rows="5" cols="30" name="info"> <?php echo $data['info']; ?></textarea>
                    <span class="require-field">*</span></td>
                </tr>
                 <tr>
                    <td class="label">是否前台显示</td>
                    <td>
                    <input type="radio" name="state" value="是"size="30" 
                     <?php if($data['state']=='是') echo 'checked="checked"'; ?>
                     />是
                    <input type="radio" name="state" value="否"size="30"
                    <?php if($data['state']=='否') echo 'checked="checked"'; ?>
                     />否
                     </td>
                </tr>
            </table>
