...
<div class="form-div search_form_div">
    <form action="/czxy/index.php/Admin/Wifisigninfo/lst" method="GET" name="search_form">
		<p>
			MAC绑定手机号：
	   		<input type="text" name="mobilephone" size="30" value="<?php echo I('get.mobilephone'); ?>" />
		</p>
