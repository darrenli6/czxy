...
<div class="form-div search_form_div">
    <form action="/czxy/index.php/Admin/Classroombinddev/lst" method="GET" name="search_form">
		<p>
			设备id：
	   		<input type="text" name="devid" size="30" value="<?php echo I('get.devid'); ?>" />
		</p>
		<p>
			教室位置：
	   		<input type="text" name="classroomaddr" size="30" value="<?php echo I('get.classroomaddr'); ?>" />
		</p>
...
<div class="list-div" id="listDiv">
	<table cellpadding="3" cellspacing="1">
		...
		<?php foreach ($data as $k => $v): ?>            
			<tr class="tron">
				<td><?php echo $v['devid']; ?></td>
				<td><?php echo $v['classroomaddr']; ?></td>
				<td><?php echo $v['roomcapacity']; ?></td>
		        <td align="center">
