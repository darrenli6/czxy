...
<div class="form-div search_form_div">
    <form action="/czxy/index.php/Admin/Admin/lst" method="GET" name="search_form">
		<p>
			用户名：
		...
		<?php foreach ($data as $k => $v): ?>            
			<tr class="tron">
		        ...
		        <td align="center">
	                ...
	                <?php if($v['id']>1): ?>
	                <a href="<?php echo U('delete?id='.$v['id'].'&p='.I('get.p')); ?>" 
	                onclick="return confirm('确定要删除吗？');" title="移除">移除</a> 
		            <?php endif; ?>
		        </td>
	        </tr>
        <?php endforeach; ?> 
