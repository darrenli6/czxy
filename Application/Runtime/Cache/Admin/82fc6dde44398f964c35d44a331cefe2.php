...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<div class="main-div">
    <form name="main_form" method="POST" action="/Test4/czxy/index.php/Admin/Cla/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input  type="text" name="tea_name" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">自习室地点：</td>
                <td>
                    <input  type="text" name="zixiarea" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">系：</td>
