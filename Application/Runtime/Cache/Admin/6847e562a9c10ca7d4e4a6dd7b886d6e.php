...
<div class="main-div">
    <form name="main_form" method="POST" action="/Test4/czxy/index.php/Admin/Classroombinddev/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">设备id：</td>
                <td>
                    <input  type="text" name="devid" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">教室位置：</td>
                <td>
                    <input  type="text" name="classroomaddr" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">教室容纳人数：</td>
                <td>
                    <input  type="text" name="roomcapacity" value="" />
                </td>
            </tr>
            <tr>
