...
<div class="main-div">
    <form name="main_form" method="POST" action="/czxy/index.php/Admin/Signsuggestion/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                <td class="label">发表意见时间：</td>
                <td>
                    <input id="suggestiondate" type="text" name="suggestiondate" value="" />
                </td>
            </tr>
            <tr>
...
<script>
$("#suggestiondate").datepicker(); 
var um = UM.getEditor('suggestion', {
