...
<div class="form-div search_form_div">
    <form action="/czxy/index.php/Admin/Wifisignsuc/lst" method="GET" name="search_form">
		<p>
			用户名：
		...
		<p>
			签到时间：
	   		从 <input id="signtimefrom" type="text" name="signtimefrom" size="15" value="<?php echo I('get.signtimefrom'); ?>" /> 
		    到 <input id="signtimeto" type="text" name="signtimeto" size="15" value="<?php echo I('get.signtimeto'); ?>" />
		</p>
...
<script>$.timepicker.setDefaults($.timepicker.regional['zh-CN']);</script>
		<script>
$('#signtimefrom').datetimepicker(); $('#signtimeto').datetimepicker(); </script>
