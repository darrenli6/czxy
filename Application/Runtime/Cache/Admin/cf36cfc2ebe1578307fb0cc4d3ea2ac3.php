...
<meta charset="utf-8">
<div class="main-div">
    <form name="main_form" method="POST" action="/Test4/czxy/index.php/Admin/Role/edit/id/1.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                ...
                <td>
                    <?php foreach($priData as $k=>$v): if(strpos(','.$rpData['pri_id'].',',','.$v['id'].',')!==false) $checked='checked="checked"'; else $checked=''; ?>
