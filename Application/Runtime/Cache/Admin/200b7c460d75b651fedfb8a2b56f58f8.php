...
<div class="main-div">
    <form name="main_form" method="POST" action="/czxy/index.php/Admin/Enterappraise/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">星级数总体评级：</td>
                <td>
                    <input  type="text" name="appraisenum" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">吐槽内容：</td>
                <td>
                    <input  type="text" name="tucao" value="" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label">企业id：</td>
                <td>
                    <input  type="text" name="enterpriseid" value="" />
                </td>
            </tr>
            <tr>
