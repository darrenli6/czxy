...
<html>
	...
	<body>
		...
		<form action="/czxy/index.php/Home/Job/apply_write.html" method="post">
		<div class="content">
			...
			<div class="list">
				...
				<input type="text" id="company_call" required="required" name="tel" placeholder="如：手机号" pattern="(\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$"/>
			</div>
		    <div class="list">
