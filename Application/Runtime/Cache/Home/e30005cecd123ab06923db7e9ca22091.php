			...
			<tr>
					<td>
						<a href="<?php echo U('gongjiaoxianlu'); ?>">
							<img src="/Test4/czxy/Public/Home/images/xianlu.jpg">
							<p>公交线路查询</p>
						</a>
					</td>
					<td>
						<a href="<?php echo U('guihua'); ?>">
							<img src="/Test4/czxy/Public/Home/images/guihua.png">
							<p>出行规划</p>
						</a>
					</td>
				</tr>
				<tr>
					<td>
						<a href="<?php echo U('express'); ?>">
							<img src="/Test4/czxy/Public/Home/images/express.png">
							<p>快递查询</p>
						</a>
					</td>
					<td>
						<a href="<?php echo U('translate'); ?>">
							<img src="/Test4/czxy/Public/Home/images/translate.png">
							<p>英文翻译</p>
						</a>
					</td>
				</tr>
				<tr>
					<td>
						<a href="<?php echo U('bus'); ?>">
							<img src="/Test4/czxy/Public/Home/images/bus.png">
							<p>长途客运车</p>
						</a>
					</td>
					<td>
						<a href="<?php echo U('weather'); ?>">
							<img src="/Test4/czxy/Public/Home/images/weather.png">
							<p>全国天气预报</p>
						</a>
					</td>
				...
				<tr>
					<td>
						<a href="<?php echo U('train'); ?>">
							<img src="/Test4/czxy/Public/Home/images/train.png">
							<p>火车余票查询</p>
						</a>
					</td>
					<td>
						<a href="<?php echo U('trainprice'); ?>">
							<img src="/Test4/czxy/Public/Home/images/trainprice.png">
							<p>火车票价查询</p>
						</a>
					</td>
				...
				<td>
						<a href="<?php echo U('answer'); ?>">
							<img src="/Test4/czxy/Public/Home/images/answer.png">
							<p>聊天智能问答机器人</p>
						</a>
					</td>
					...
					<td>
						<a href="<?php echo U('brain'); ?>">
							<img src="/Test4/czxy/Public/Home/images/brain.png">
							<p>脑筋急转弯大全</p>
						</a>
					</td>
			 </tr>
			<tr>
					<td>
						<a href="<?php echo U('smile'); ?>">
							<img src="/Test4/czxy/Public/Home/images/smile.png">
							<p>笑话</p>
						</a>
					</td>
				<td>
						<a href="<?php echo U('xingzuo'); ?>">
							<img src="/Test4/czxy/Public/Home/images/xingzuo.png">
							<p>星座预测</p>
						</a>
					</td>
			...
			<tr>
					...
					<td>
						<a href="<?php echo U('zhaocha'); ?>">
							<img src="/Test4/czxy/Public/Home/images/zhao.png">
							<p>找茬游戏</p>
						</a>
					</td>
					 ...
					 <td>
						<a href="<?php echo U('baikuai'); ?>">
							<img src="/Test4/czxy/Public/Home/images/baikuai.jpg">
							<p>别踩白块游戏</p>
						</a>
					</td>
