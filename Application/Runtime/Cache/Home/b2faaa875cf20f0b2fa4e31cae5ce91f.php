    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-8 col-centered">
          <form method="post"  id="register-form" autocomplete="off" action="/Test4/czxy/index.php/Home/LogReg/forget.html" class="nice-validator n-default" novalidate>
            <div class="form-group">
              <input type="text" class="form-control" id="mobilephone" name="mobilephone" onblur="isExists();" onchange="checkm();" placeholder="手机号" autocomplete="off" aria-required="true" data-tip="英文字母数字或下划线">
              <span id="ret" ></span>
            </div>
