...
<body>
	...
	<div class="content">
	   <div class="teacherC">
			<!-- 查询 -->
			<form class="mui-input-group" method="get" action="/czxy/index.php/Home/Teaching/teach" name="czxy">
	...
	<div class="cover_table">
		<div class="exit">
			<img src="/czxy/Public/Home/images/exit.png" height="50" width="50">
		</div>
		<table>
			<tr>
				<th>科目</th>
	...
	<!-- loading jquery -->
	<script type="text/javascript" src="/czxy/Public/Home/js/jquery-1.12.1.min.js"></script>
	<!-- loading mui -->
	<script type="text/javascript" src="/czxy/Public/Home/js/mui.min.js"></script>
	 
	 
	<!-- loading class-data -->
	<script type="text/javascript" src="/czxy/Public/Home/js/time-data.js"></script>
